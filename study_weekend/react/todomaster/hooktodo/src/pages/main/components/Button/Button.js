...
=====================================================================
keyPoint
 함수형 컴포넌트는 매개변수로 전달된 속성값을 객체 형태로 받는다.
 styled component는 속성으로 전달된 값을 콜백함수의 인자로 꺼내쓸 수 있다.
 이를 활용하여 유동적인 css변경이 가능하며 이를 통해 유동적인 공용컴포넌트를 만들수 있다.
 나머지 매개변수를 통해 props를 명시하지 않은 key값도 전달 받을 수 있다.
*/